...
public class Main {
    ...
    static void tambahBarang() throws IOException {
        System.out.print("\033[H\033[2J");
        ...
        System.out.print("Apakah barang ini merupakan jasa kirim? (y/n)");
        String isJasaKirim = br.readLine();
    
        if (isJasaKirim.equalsIgnoreCase("y")) {
            ...
            System.out.print("Apakah layanan pengiriman ini adalah Jasa Pengiriman Ekspress? (y/n)");
            String isJasaPengirimanEkspress = br.readLine();
    
            if (isJasaPengirimanEkspress.equalsIgnoreCase("y")) {
                System.out.print("Masukkan waktu pengiriman (dalam hari): ");
                int waktuPengiriman = Integer.parseInt(br.readLine());
    
                JasaKirim.JasaPengirimanEkspress jasaPengirimanEkspress = new JasaKirim.JasaPengirimanEkspress(nama, jumlah, berat, tujuan, jenisLayanan, biaya, waktuPengiriman);
                daftarBarang.add(jasaPengirimanEkspress);
            }
        }
        br.readLine();
        System.out.print("\033[H\033[2J");
            ...
            for (int i = 0; i < daftarBarang.size(); i++) {
                ...
                if (daftarBarang.get(i) instanceof JasaKirim) {
                    ...
                    if (daftarBarang.get(i) instanceof JasaKirim.JasaPengirimanEkspress) {
                        JasaKirim.JasaPengirimanEkspress jasaPengirimanEkspress = (JasaKirim.JasaPengirimanEkspress) daftarBarang.get(i);

                        System.out.println("Waktu Pengiriman: " + jasaPengirimanEkspress.getWaktuPengiriman() + " hari");
                    }
                }
            }
        }
    ...
    static void ubahBarang() throws IOException {
        ...
        if (daftarBarang.isEmpty()) {
            ...
            if (idBarang <= daftarBarang.size()) {
                ...
                System.out.print("Masukkan nama barang baru (kosongkan jika tidak diubah): ");
                String nama = br.readLine();
                if (!nama.isEmpty()) {
                    barang.setNama(nama);
                }
