...
public class Main {
    ...
    public static void tambahBarang() throws IOException {
        ...
        if (jenisLayanan.equalsIgnoreCase("Ekspress")) {
            System.out.print("Waktu Pengiriman (hari): ");
            int waktuPengiriman = Integer.parseInt(br.readLine());
            JasaKirim.JasaPengirimanEkspress newBarang = new JasaKirim.JasaPengirimanEkspress(nama, jumlah, berat,
                    tujuan, jenisLayanan, biaya, waktuPengiriman);
            daftarBarang.add(newBarang);
        } else {
            JasaKirim newBarang = new JasaKirim(nama, jumlah, berat, tujuan, jenisLayanan, biaya, biaya);
            daftarBarang.add(newBarang);
        }
